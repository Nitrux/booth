...
checkinstall -D -y \
	...
	--provides=booth \
	--requires="libc6,libgcc-s1,libkf5coreaddons5,libkf5i18n5,libqt5core5a,libqt5gui5,libqt5qml5,libqt5quick5,libqt5widgets5,libqt5multimedia5,libqt5multimediagsttools5,libqt5multimediaquick5,libqt5multimediawidgets5,libstdc++6,mauikit-git \(\>= 3.1.0+git\)" \
	--nodoc \
	--strip=no \
	--stripso=yes \
	--reset-uids=yes \
